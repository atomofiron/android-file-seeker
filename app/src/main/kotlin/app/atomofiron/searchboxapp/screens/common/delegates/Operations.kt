...
object Operations {
    ...
    val Paste = MenuItem(id = Increment(), UniText(R.string.paste), R.drawable.ic_insert_file)
    val ByCopying = MenuItem(id = Increment(), UniText(R.string.by_copying), R.drawable.ic_insert_copy_file, secondary = true)
    val ByMoving = MenuItem(id = Increment(), UniText(R.string.by_moving), R.drawable.ic_insert_move_file, secondary = true)

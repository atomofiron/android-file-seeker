...
object Operations {
    ...
    val ByCopying = MenuItem(id = Increment(), UniText(R.string.by_copying), R.drawable.ic_insert_copy_file)
    val ByMoving = MenuItem(id = Increment(), UniText(R.string.by_moving), R.drawable.ic_insert_move_file)

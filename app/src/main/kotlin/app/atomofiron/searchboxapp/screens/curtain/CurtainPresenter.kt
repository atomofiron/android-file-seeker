...
class CurtainPresenter @Inject constructor(
    private val params: CurtainParams,
    ...
    override val requestId: CurtainId = params.id
    ...
    override fun showNext(key: CurtainKey) {
        viewState.action[scope] = CurtainAction.ShowNext(key.id)
    }
